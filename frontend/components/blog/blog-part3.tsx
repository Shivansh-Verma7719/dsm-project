  ...
  return (
    <section className="mb-32 relative">
      ...
      <div className="relative z-10">
        ...
        <p className="font-mono text-[0.6rem] text-[#5a6374] uppercase tracking-widest mb-12">Three models · HistGradientBoosting · Permutation Importance</p>
        ...
        <div className="font-sans text-[#8a93a3] leading-relaxed text-lg space-y-6 mb-12">
          <p>
            We chose <strong className="text-[#c2c7d0]">Histogram-based Gradient Boosting (HGB)</strong> for
          ...
          <p>
            The key design decision was <strong className="text-[#c2c7d0]">class balancing</strong>. With 74.5%
...
# >>> 0.814`}
        ...
        <div className="font-sans text-[#8a93a3] leading-relaxed text-lg space-y-6 mb-12">
          <p>
            ...
            <strong className="text-[#c2c7d0]"> Product Awareness</strong> — the count of financial
            ...
            {FEATURES.map((f, i) => (
              <div key={f.label}>
                <div className="flex justify-between text-xs mb-1.5">
                  <span className="text-[#c2c7d0] font-space-grotesk">{f.label}</span>
                  <span className="font-mono text-[#5a6374]">{f.raw}</span>
                </div>
                <div className="h-2 bg-[#1a1f2b] rounded-full overflow-hidden">
                  <motion.div
                    ...
                    style={{ background: i === 0 ? 'var(--data-1)' : '#4a5568' }}
                  />
                </div>
              </div>
            ))}
