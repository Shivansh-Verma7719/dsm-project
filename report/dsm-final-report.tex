...
Comparing these estimates against a baseline eleven-variable specification (excluding awareness), the ORs for income and education fall by 0.20 and 0.31 respectively. This partial mediation indicates that high-income and educated respondents tend to know more financial products, and it is partly this familiarity that converts to participation. Critically, however, both income and education retain large independent effects after controlling for awareness, confirming that awareness is not merely a socioeconomic proxy---it is a distinct, policy-actionable lever.
