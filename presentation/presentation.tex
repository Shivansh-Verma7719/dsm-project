...
\begin{frame}{EDA: Who Participates?}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \begin{block}{Urban Premium}
        ...
        \small Urban vs Rural households
      \end{block}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{Gender Gap}
        ...
        \small Male vs Female — gap persists across all income levels
      \end{block}
      \vspace{0.4em}
  ...
  \end{columns}
  \vspace{0.5em}
  \small Which factors survive joint controls? $\to$ Finding 1.
\end{frame}
...
\begin{frame}{EDA: Awareness Gap and Holdings}
  ...
  \end{columns}
  \vspace{0.8em}
  MFs and FDs co-dominate: investors layer market products on top of
...
\begin{frame}{Finding 4: Investor Education Programme Impact}
  ...
  \end{center}
  \vspace{0.6em}
  The 41\% knowledge advantage is in \emph{depth}, not breadth: both groups
  are aware of the same number of products. IEP changes how well people
  understand what they already know. Current reach: \alert{9.9\%}.
\end{frame}
